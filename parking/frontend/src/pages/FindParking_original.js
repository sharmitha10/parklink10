...
const FindParking = () => {
  ...
  }, [userLocation, searchRadius, liveUpdateTrigger]);
...
// Legend Component
  ...
  // Simulated Live Update (from your HTML code)
  useEffect(() => {
    const timer = setTimeout(() => {
      alert(" Live Update: A parking slot status has changed!\);
...
// Legend Component (from your HTML code)
const Legend = () => {
  const map = useMap();
  useEffect(() => {
